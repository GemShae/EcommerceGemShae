        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center product-polaroid">
                    <img class="img-fluid image-size p-2 p-sm-3 product-image" alt="PhotoShoot" src="images/Upendo.JPG" />
...
Pictures delivered via online mediums of your choice."
                            BorderStyle="Groove" TextMode="MultiLine" class="image-size" Height="100px" OnTextChanged="PhotoShootDescriptionTextBox_TextChanged" Width="330px"></asp:TextBox> <br />
                ...
                <%--SECOND PRODUCT - DJ--%>
                <div class="col-md-4 text-center product-polaroid">
                    <img class="img-fluid image-size p-2 p-sm-3 product-image" alt="DJ" src="images/Djing.JPG" />
                    <div class="polaroid-container">
...
Equipment may be provided for an extra cost." BorderStyle="Groove" class="image-size" Height="100px" Width="330px"></asp:TextBox> <br />
                ...
                <div class="col-md-4 text-center product-polaroid">
                    <img class="img-fluid image-size p-2 p-sm-3 product-image" alt="Dancer" src="images/Dancer.jpg" />
                    <div class="polaroid-container">
                        <h4>Dancer/s </h4>
                        ...
                        <asp:TextBox ID="DanceDescriptionTextbox" runat="server" ReadOnly="True" Text="Professional Dancer/s versatile with coming up with routines to various genres."
                            BorderStyle="Groove" TextMode="MultiLine" class="image-size" Height="100px" Width="330px"></asp:TextBox> <br />
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center product-polaroid">
                    <img class="img-fluid image-size p-2 p-sm-3 product-image" alt="Motivational Speaking" src="images/Shanya MS.jpg" />
                    <div class="polaroid-container">
                ...
                <div class="col-md-6 text-center product-polaroid">
                    <img class="img-fluid image-size p-2 p-sm-3 product-image" alt="Video Editing" src="images/Videoing.JPG" />
                    <div class="polaroid-container">
                        <h4>Video Editing </h4>
